...
{[\tikzmark{Taroo} [\textit{i}* [\textsc{vP} die-\textsc{caus} [\textsc{dp} \textsc{\tikzmark{possessor}} son]]]]} \\
...
\citet{Wechsler2016} concludes that there are four hypothetical scopal interactions in a construction where both an applicative and a causative affix to an unergative stem. They are illustrated with English examples and tree diagrams in Figures \ref{ex:wechsler:8}--\ref{fig:wechsler:12}.\todo{one less?} 
...
\glt {i. ‘Tinotenda made Chipo, for Tatenda, dance.’}   \textsc{[caus[hi-appl[vP]]]}\\
\glt {ii. ‘Tinotenda, for Tatenda, made Chipo dance.’}  \textsc{[hi-appl[caus[vP]]]}\\
\glt  {iii. ‘Tinotenda, instead of Tatenda, made Chipo dance.’}  \textsc{[sh-appl[caus[vP]]]}\\
\glt {{iv.} {*‘Tinotenda} {made} {Chipo,} {instead} {of} {Tatenda,} {dance.’}}  {\textsc{[caus[sh-appl[vP]]]}}\\
\z
