...
Voice is simply the product of \textit{i}* merging with the verbalizing head little v and allowing for the introduction of an external agentive argument. \figref{fig:wechsler:1}, adapted from their work \citeyearpar[261]{WoodMarantz2017}, demonstrates this structure.
...
\langinfo{}{}{[Taroo [\textit{i}* [\textsc{vP} die-\textsc{caus} [\textsc{dp} \textsc{possessor} son]]]]} \\
\z
...
\textit{\figref{fig:wechsler:2}: The identical structures of Venda and Shona causatives} 
...
\textit{\figref{fig:wechsler:3}: The structure of a causativized unergative in Japanese}
...
\textit{\figref{fig:wechsler:5}: Partial structure of the low} \textsc{appl} \textit{construction} \textit{‘Miriam} \textit{gave} \textit{the} \textit{children} \textit{a} \textit{gift.’}
...
\textit{\figref{fig:wechsler:6}: Partial structure of the high} \textsc{appl} \textit{construction} \textit{‘John} \textit{held} \textit{the} \textit{purse} \textit{for} \textit{Mary.’}
...
\textit{\figref{fig:wechsler:7}: Structure of the super-high} \textsc{appl} \textit{construction} \textit{in} \textit{(\ref{ex:wechsler:19})}
...
\textit{\figref{fig:wechsler:8}: Causativized high applicative: Tinotenda made Chipo dance for Tatenda (such that Tatenda benefitted from the dancing)}
...
\textit{\figref{fig:wechsler:10}: Super-high applicativized causative: Tinotenda, instead of Tatenda made Chipo dance (such that Tatenda did not have to make Chipo dance)}
...
\textit{\figref{fig:wechsler:11}: Causativized Super-high applicative: Tinotenda made Chipo dance instead of Tatenda (such that Tatenda did not have to dance)}
