...
On the contrary, the \textit{a} preposition/dative case with \textit{see} in \REF{ex:manzini:6} is structural, since it depends not on the selection properties of the verb, but on the DOM configuration. More explicitly, I assume that under DOM, a highly ranked referent cannot be embedded as a theme, but must be embedded with a role at least as high as that of possessor/locator of the VP subevent, as schematized in \REF{ex:manzini:8}. \todo{something missing}
