...
\ea%2
    ...
    \ex%2b
        ...
        \todo[inline]{maybe use `sweets' instead of `candy' as it is plural}
    \z
\z
...
\todo{what is the meaning of \textsc{cl}}
\ea%3
    \label{ex:cuervo:3}
    Affected datives\\
    \ea%3a
...
\ea%8
    ...
    \ea%8a
        ...
        \footnotetext{Following \citealt{Cuervo2003}, I assume here that the particle \textit{encima} acts as the predicate in a small-clause-type of structure, which the applicative head takes as its complement. Unlike there, however, I take the datives in \REF{ex:cuervo:8} to be low applicatives because they are merged as a complement of the verb. See \citet{Acedo-Matellán2017} for an Affected Appl analysis of special datives in Latin.}
    \ex%8b
        \label{ex:cuervo:8b}
