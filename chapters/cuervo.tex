...
\footnotetext{I assume here a bi-eventive analysis of anticausative constructions whereby a dynamic event—a \liv P\textsc{go} expressing the change—embeds a state—a \liv P\textsc{be} (see \citealt{Cuervo2003,Cuervo2015Syntax}). Thus, an \textsc{affected} applicative taking a stative \liv P as complement is embedded under the dynamic \liv P both in causative and anticausative constructions.}
