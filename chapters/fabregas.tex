...
\ea%1
    ...
    \gll    A Juan   le       agrada   París (*rápidamente).       \\
            {to} {Juan}   {him.}\textsc{dat}   {pleases}   {Paris} {(*quickly)} \\}\jambox*{DAT}
    \ex{\label{ex:fabregas:1b}
    \gll    A Juan   le       gusta Sandra (*rápidamente).          \\
            {to} {Juan}   {him.}\textsc{dat}   {likes}   {Sandra} {(*quickly)} \\}\jambox*{DAT}
    \ex{\label{ex:fabregas:1c}
    \gll    A Juan   le       duele la cabeza (*rápidamente).         \\
            {to} {Juan}   {him.}\textsc{dat}   {hurts} {the} {head} {(*quickly)}\\}\jambox*{DAT}
    \z
\z
...
\ea%2
    ...
    \gll    Juan  se  olvida   de todo   (rápidamente).               \\
            {Juan} {SE} {forgets}   {of}   {all}   {(quickly)} \\}\jambox*{REFL}
    \ex{\label{ex:fabregas:2b}
    \gll    Juan  se  acuerda     de todo   (rápidamente).           \\
            {Juan} {SE} {remembers}   {of}   {all}   {(quickly)}\\}\jambox*{REFL}
    \ex{\label{ex:fabregas:2c}
    \gll    Juan  se desentiende        de todo   (rápidamente).     \\
            {Juan} {SE} {pretends.not.to.know} {of} {all}   {(quickly)}\\}\jambox*{REFL}
...
\ea%3
    ...
    \gll    *A Juan paró     de agradarle   París.                  \\
            \hspaceThis{*}{to} {Juan} {stopped}   {of}   {loving}     {Paris} \\}\jambox*{DAT}
    \ex{\label{ex:fabregas:3b}
    \gll    *A Juan paró     de gustarle     María.                \\
            \hspaceThis{*}{to} {Juan}  {stopped}  {of} {liking}      {María}\\}\jambox*{DAT}
    \ex{\label{ex:fabregas:3c}
    \gll    *A Juan  paró     de dolerle la   cabeza.                \\
            \hspaceThis{*}{to} {Juan} {stopped}   {of} {hurting} {the} {head}\\}\jambox*{DAT}
    \z
\z
...
\ea%4
    ...
    \gll    Juan paró      de olvidarse   de pagar   las facturas.          \\
            {Juan} {stopped} {of} {forgetting} {of} {paying} {the} {bills}\\}\jambox*{REFL}
    \ex{\label{ex:fabregas:4b}
    \gll    Juan paró      de acordarse    de todos los cumpleaños.      \\
            {Juan} {stopped} {of} {remembering} {of} {all}      {the} {birthdays}\\}\jambox*{REFL}
    \ex{\label{ex:fabregas:4c}
    \gll    Juan paró       de desentenderse         de sus hijos.      \\
            {Juan} {stopped}   {of} {pretending.not.to.know}   {of} {his}  {children}\\}\jambox*{REFL}
    \z
\z
...
\ea%5
    ...
    \gll    A Juan  le       preocupan   las cosas (*rápidamente).        DAT\\
            {to} {Juan} {him.}\textsc{dat} {worry}      {the} {things} {(*quickly)}\\}\jambox*{DAT}
    \ex{\label{ex:fabregas:5b}
    \gll    Juan  se   preocupa por las cosas (rápidamente).           \\
            {Juan} {SE} {worries}   {for}  {the} {things} {(quickly)}\\}\jambox*{REFL}
    \z
\z
...
\ea%6
    ...
    \gll    *A Juan  pararon de preocupar-le las cosas.             \\
            \hspaceThis{*}{to} {Juan} {stopped} {of} {worry-him}   {the} {things}\\}\jambox*{DAT}
    \ex{\label{ex:fabregas:6b}
    \gll    Juan paró      de preocupar-se siempre por sus hijos.          \\
            {Juan} {stopped} {of} {worry-SE}    {always}  {for}  {his} {children}\\}\jambox*{REFL}
    \z
\z
...
\ea%7
    ...
    \gll    A María sus hermanas   la       asustan (rápidamente).      \\
            to María her sisters     her.acc   frighten (quickly)\\}\jambox*{ACC}
    \ex{\label{ex:fabregas:7b}
    \gll    A María la oscuridad   le       asusta (*rápidamente).       \\
            to María the darkness   her.dat   frightens (*quickly)\\}\jambox*{DAT}
    \z
\z

\ea%8
    \label{ex:fabregas:8}
    \ea{\jambox*{DAT}\label{ex:fabregas:8a}
    \gll    A María paró     de asustarla su hermano.              \\
            to María stopped of scare-her her brother\\}\jambox*{ACC}
    \ex{\label{ex:fabregas:8b}
    \gll    *A María paró   de asustarle   la economía.            DAT\\
            \hspaceThis{*}to María stopped of scare-her   the economy\\}\jambox*{DAT}
    \z
\z
...
\ea{%11
    ...
    \gll    A Juan  se   le       olvidan las cosas (rápidamente).      \\
            {to} {Juan} {SE} {him.}\textsc{dat}   {forget}   {the} {things} {(quickly)}\\}\jambox*{DAT+REFL}
